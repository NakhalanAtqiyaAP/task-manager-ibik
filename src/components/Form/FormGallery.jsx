      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
          <div className="flex gap-2">
            <label className="cursor-pointer bg-purple-400 border-2 border-black px-3 py-1.5 font-black text-xs uppercase flex items-center gap-2 hover:translate-x-0.5 hover:translate-y-0.5 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:shadow-none transition-all">
              <Image size={16} /> FOTO
          ...
          <button 
            type="submit" 
            disabled={uploading}
            className="bg-green-400 text-black border-4 border-black px-6 py-2 font-black uppercase flex items-center gap-2 hover:bg-green-500 disabled:opacity-50 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none transition-all"
          >
